...
public class Connection {
  ...
  //public enum stateEnum { created, waiting, connecting, completed, uploading, question, answered, manual, incorrect, error, disabled, }; 
  ...
  //public enum validationEnum { never, pending, done, }; 
